...
resource "azurerm_key_vault" "kv" {
  ...
  tenant_id                   = lookup(each.value, "tenant_id", null) != null && lookup(each.value, "tenant_id", "") != "00000000-0000-0000-0000-000000000000" ? each.value.tenant_id : data.azurerm_client_config.current.tenant_id
